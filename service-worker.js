...
// v1.3.19: Edit ride hydrates from the owner-authenticated server
// snapshot (fail-closed) — precached indexMVP.html and the modal scripts
// must refresh everywhere. (v1.3.18 shipped in-place pending editing;
// v1.3.17 shipped PR 1A pending cancellation.)
