...
const GROUPS: { heading: string; blurb: string; links: { href: string; label: string; note?: string }[] }[] = [
  ...
  { heading: "Model", blurb: "The pieces and how they seem connected.", links: [{ href: "/variables", label: "Variables" }, { href: "/map", label: "Map", note: "connections and feedback patterns" }, { href: "/constraints", label: "Constraints" }, { href: "/profile", label: "System profile" }] },
  { heading: "Investigation", blurb: "Explanations under test and the decisions around them.", links: [{ href: "/hypotheses", label: "Hypotheses" }, { href: "/proposals", label: "Review", note: "decisions waiting for you" }, { href: "/explore", label: "Explore a pattern" }, { href: "/evidence", label: "Evidence and assumptions" }, { href: "/research", label: "Research", note: "collect evidence for an explanation from a source file" }] },
  { heading: "Advanced analysis", blurb: "The engineering views. Useful, dense, optional.", links: [{ href: "/overview", label: "Overview", note: "the former dashboard: current versus desired" }, { href: "/desired", label: "Desired state" }, { href: "/gap", label: "Structural gap" }, { href: "/attractor", label: "Current attractor" }, { href: "/leverage", label: "Leverage points" }, { href: "/scenarios", label: "Scenario simulator" }, { href: "/ai", label: "AI diagnostics", note: "exactly what the assistant receives; demo output" }] },
];
