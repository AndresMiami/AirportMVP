...
const GROUPS: { heading: string; blurb: string; links: { href: string; label: string; note?: string }[] }[] = [
  ...
  { heading: "Investigation", blurb: "Explanations under test and the decisions around them.", links: [{ href: "/hypotheses", label: "Hypotheses" }, { href: "/proposals", label: "Review", note: "decisions waiting for you" }, { href: "/explore", label: "Explore a pattern" }, { href: "/evidence", label: "Evidence and assumptions" }] },
