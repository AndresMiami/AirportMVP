 ...
 * - Service area limited to 280 miles (Tampa)
 */
...
export class PricingService {
        ...
        this.vehicleConfig = {
            tesla: {
                ...
                priceTiers: [
                    ...
                    { minMiles: 101, maxMiles: 280, rate: 2.15 }  // Very long distance (up to Tampa ~280mi)
                ],
                airportFee: 10,
                hourlyProtection: 100,
                capacity: { passengers: 4, bags: 4 },
                maxDistance: 280  // Service limit
            },
            escalade: {
                ...
                priceTiers: [
                    ...
                    { minMiles: 101, maxMiles: 280, rate: 2.95 }  // Very long distance (up to Tampa ~280mi)
                ],
                airportFee: 15,
            ...
            sprinter: {
                ...
                priceTiers: [
                    ...
                    { minMiles: 101, maxMiles: 280, rate: 4.25 }  // Very long distance (up to Tampa ~280mi)
                ],
                airportFee: 25,
    ...
    calculateVehiclePrice(vehicleType, distance, duration, options = {}) {
        ...
        // Check if distance exceeds service area (Tampa is ~280 miles)
        if (distance > 280) {
